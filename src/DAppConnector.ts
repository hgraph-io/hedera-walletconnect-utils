...
import { HederaWalletConnectMethod, accountAndLedgerFromSession, networkNamespaces } from './lib'
...
export class DAppConnector {
  ...
  constructor(
    ...
    this.supportedMethods = methods ?? Object.values(HederaWalletConnectMethod)
